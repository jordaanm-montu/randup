  ...
  return (
    <div style={{margin: '1rem'}}>
      ...
      <ActionsRow>
        ...
        <Button variant='contained' onClick={() => unshuffle()}>Un-Shuffle</Button>
        <Button variant='contained' onClick={openDialog}>Edit</Button>
        <Button variant='contained' onClick={hideAll}>Hide All</Button>
